...
namespace DentWhiteTest.TestCase.Docker
{
    public class LoginDentureTest
    {
        ...
        /// <returns></returns>
        public static bool LoginDenture_UserNull_PwdNull(Window appWin, out string msg)
        {
            try
            {
        ...
        /// <param name="msg"></param>
        /// <returns></returns>
        public static bool LoginDenture_UserNull(Window appWin, out string msg)
        {
            try
            {
                var startTime = DateTime.Now;
        ...
        /// <param name="msg"></param>
        /// <returns></returns>
        public static bool LoginDenture_Success(Window appWin, out string msg)
        {
            try
            {
                var startTime = DateTime.Now;
        ...
        /// <param name="msg"></param>
        /// <returns></returns>
        public static bool LoginDenture_PwdNull(Window appWin, out string msg)
        {
            try
            {
                var startTime = DateTime.Now;
        ...
        /// <param name="msg"></param>
        /// <returns></returns>
        public static bool LoginProduct_Success(Window appWin, out string msg)
        {
            try
            {
                var startTime = DateTime.Now;
